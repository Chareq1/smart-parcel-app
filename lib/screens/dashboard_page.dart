...
import 'package:smart_parcel_box_app/screens/settings_page.dart';
...
class _DashboardPageState extends State<DashboardPage>
  ...
  late ParcelBoxData parcelBoxData = ParcelBoxData(
    temperature: 25.0,
    doorState: false,
    parcelCount: 0,
    isSpaceAvailable: true,
    mainDoorElectromagneticLock: true,
    parcelDoorStepMotorLock: true,
    humidity: 50,
  );

  // MQTT Service
  late MQTTService mqtt = MQTTService(
    'mqtt.smaartparcelbox.app',
    [
      'smart-parcel-box/data',
      'smart-parcel-box/status',
      'smart-parcel-box/settings',
    ],
    onMessage: (topic, payload) {
      if (topic == 'smart-parcel-box/status') {
        ...
        setState(
          () => description = response['description'] ?? 'My parcel box',
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: !_isDeviceConnectedToInternet
          ? Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                                      ...
                                      if (_isOnline) {
                                        setState(() {
                                          if (parcelBoxData
                                            ...
                                            const pubTopic =
                                                'smart-parcel-box/cmd/unlock-main-door';
                                            final builder =
                                            ...
                                            const pubTopic =
                                                'smart-parcel-box/cmd/lock-main-door';
                                            final builder =
                                                MqttClientPayloadBuilder();
                                            parcelBoxData
                                                    .mainDoorElectromagneticLock =
                                  ...
                                  child: buildButton(
                                    ...
                                    () {
                                      if (_isOnline) {
                                        setState(() {
                                          if (parcelBoxData
                                              .parcelDoorStepMotorLock) {
                                            const pubTopic =
                                                'smart-parcel-box/cmd/unlock-parcel-door';
                                            final builder =
                                                MqttClientPayloadBuilder();
                                            parcelBoxData
                                                    .parcelDoorStepMotorLock =
                                            ...
                                            const pubTopic =
                                                'smart-parcel-box/cmd/lock-parcel-door';
                                            final builder =
                                                MqttClientPayloadBuilder();
                                            parcelBoxData
                                                    .parcelDoorStepMotorLock =
                                  ...
                                  child: buildButton(
                                    ...
                                    () async {
                                      if (parcelBoxData.parcelCount > 0) {
                                        ...
                                        var result = await showUnloadDialog(
                                          context,
                                        );
                                        while (result != true) {
                                          result = await showUnloadDialog(
                                            context,
                                          );
                                        }
                                        if (result == true) {
                                          if (_isOnline) {
                                            const pubTopic =
                                                'smart-parcel-box/cmd/unload-box';
                                            final builder =
                                                MqttClientPayloadBuilder();
                                            mqtt.mqttClient.publishMessage(
                                              pubTopic,
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: buildTile(
                                    ...
                                    "Temperature",
                                    "${parcelBoxData.temperature.toStringAsFixed(1)} °C",
                                    color:
                                        parcelBoxData.temperature >
                                            maximalTemperature
                                        ? Colors.redAccent
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: buildTile(
                                    ...
                                    "Door state",
                                    parcelBoxData.doorState ? "Open" : "Closed",
                                  ),
                                ),
                                Expanded(
                                  flex: 1,
